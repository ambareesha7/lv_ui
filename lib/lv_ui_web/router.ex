defmodule LvUiWeb.Router do
  use LvUiWeb, :router

  import LvUiWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {LvUiWeb.Layouts, :root}
  ...
  scope "/", LvUiWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{LvUiWeb.UserAuth, :redirect_if_user_is_authenticated}] do
